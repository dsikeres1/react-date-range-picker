...
| Size      | Cell Size | Font Base | Trigger Min Width |
| --------- | --------- | --------- | ----------------- |
...
<Admonition type="tip">
  The `medium` size is the default and doesn't apply any overrides. The base variables in
  `variables.css` are the medium values.
</Admonition>
