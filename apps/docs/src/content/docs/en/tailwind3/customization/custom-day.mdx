...
Use the `Day` component's render prop to customize each day cell. This is useful for adding event indicators, custom styling based on date properties, or entirely replacing the day rendering.
