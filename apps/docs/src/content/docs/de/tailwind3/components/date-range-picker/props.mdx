...
| `open`                   | `boolean`                                                     | --          | Gesteuerter "offen"-Zustand                                                    |
| `initialOpen`            | `boolean`                                                     | --          | Initialer "offen"-Zustand (ungesteuert)                                        |
...
| `shouldCloseOnSelect`    | `boolean`                                                     | `false`     | Automatisch bestätigen, wenn das Enddatum ausgewählt ist                       |
