...
| --------------------- | --------------------------------------------- | ----------- | ------------------------------------------------- |
| `value`               | `Date \| null`                                | --          | Giá trị ngày-giờ đã chọn                          |
| `onChange`            | `(dateTime: Date \| null) => void`            | --          | Hàm gọi lại khi giá trị thay đổi                  |
...
| `shouldCloseOnSelect` | `boolean`                                     | `false`     | Tự động xác nhận khi nhấp vào cài đặt trước       |
| `numberOfMonths`      | `number`                                      | `1`         | Số tháng cần hiển thị                             |
