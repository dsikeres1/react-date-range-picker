...
| `isDateUnavailable`   | `(date: Date) => boolean`                     | --          | Đánh dấu ngày là không khả dụng                      |
...
| `fromYear`            | `number`                                      | --          | Năm bắt đầu cho menu thả xuống                       |
| `toYear`              | `number`                                      | --          | Năm kết thúc cho menu thả xuống                      |
