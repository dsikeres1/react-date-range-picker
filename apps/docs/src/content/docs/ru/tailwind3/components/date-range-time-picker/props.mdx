...
| `time`                   | `TimeConfig`                                                  | --          | Конфигурация панели времени (применяется к началу и концу)            |
...
| `open`                   | `boolean`                                                     | --          | Контролируемое состояние открытости                                   |
| `initialOpen`            | `boolean`                                                     | --          | Начальное состояние открытости (неконтролируемое)                     |
| `onOpenChange`           | `(open: boolean) => void`                                     | --          | Обратный вызов при изменении состояния открытости                     |
...
| `shouldCloseOnSelect`    | `boolean`                                                     | `false`     | Автоматическое подтверждение по клику на пресет                       |
...
| `placeholder`            | `string`                                                      | --          | Текст плейсхолдера для триггера                                       |
