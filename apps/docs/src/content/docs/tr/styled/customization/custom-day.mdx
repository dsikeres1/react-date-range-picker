...
Her gün hücresinin görünüşünü özelleştirmek için 'Gün' bileşeninin oluşturma özelliğini kullanın. Bu, ayrı ayrı günlere etkinlik göstergeleri, araç ipuçları veya tamamen özel stil eklemek için kullanışlıdır.
