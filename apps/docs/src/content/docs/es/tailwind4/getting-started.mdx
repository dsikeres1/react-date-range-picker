...
No se necesita ninguna importación de CSS adicional. Los componentes utilizan clases de utilidad de Tailwind directamente.
...
En ese caso, importa el `reset.css` proporcionado para inicializar manualmente los estilos de los botones:
