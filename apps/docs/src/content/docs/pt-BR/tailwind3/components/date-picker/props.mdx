...
| `onChange`            | `(date: Date \| null) => void`                | --          | Função de retorno quando o valor muda                    |
...
| `displayFormat`       | `string`                                      | --          | Formato de exibição personalizado (ex. `"YYYY/MM/DD"`)   |
| `open`                | `boolean`                                     | --          | Estado de abertura controlado                            |
| `initialOpen`         | `boolean`                                     | --          | Estado de abertura inicial (não controlado)              |
| `onOpenChange`        | `(open: boolean) => void`                     | --          | Função de retorno quando o estado de abertura muda       |
...
| `inline`              | `boolean`                                     | `false`     | Exibir calendário em linha (sem popup)                   |
| `name`                | `string`                                      | --          | Nome do campo de entrada oculto para envio de formulário |
