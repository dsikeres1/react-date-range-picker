...
| --------------------- | --------------------------------------------- | --------------------- | ------------------------------------------------ |
| `value`               | `Date \| null`                                | --                    | ค่าวันที่ที่ถูกเลือก                             |
...
| `captionLayout`       | `"buttons" \| "dropdown"`                     | `"buttons"`           | รูปแบบการนำทางของ caption                        |
| `fromYear`            | `number`                                      | --                    | ปีเริ่มต้นสำหรับ dropdown                        |
| `toYear`              | `number`                                      | --                    | ปีสิ้นสุดสำหรับ dropdown                         |
| `disablePast`         | `boolean`                                     | `false`               | ปิดการใช้งานวันที่ก่อนวันนี้                     |
| `disableFuture`       | `boolean`                                     | `false`               | ปิดการใช้งานวันที่หลังวันนี้                     |
| `inline`              | `boolean`                                     | `false`               | แสดงปฏิทินในบรรทัด (ไม่มี popup)                 |
| `name`                | `string`                                      | --                    | ชื่อ input ที่ซ่อนไว้สำหรับการส่งฟอร์ม           |
| `placeholder`         | `string`                                      | --                    | ข้อความ placeholder ของ trigger                  |
