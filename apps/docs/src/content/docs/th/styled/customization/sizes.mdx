...
แพ็คเกจ styled มีตัวแปรขนาดในตัว 4 แบบที่ปรับขนาดตัวอักษร, ระยะห่าง, ขนาดเซลล์ และขนาดทริกเกอร์ตามสัดส่วน

## ขนาดที่มีให้เลือก

| ขนาด      | ขนาดเซลล์ | ขนาดฟอนต์พื้นฐาน | ความกว้างขั้นต่ำของทริกเกอร์ |
| --------- | --------- | ---------------- | ---------------------------- |
...
`medium` เป็นค่าเริ่มต้น

## การใช้งาน

ส่ง prop `size` ไปยังคอมโพเนนต์ตัวเลือกใดก็ได้:
...
## อะไรที่เปลี่ยนแปลงไปในแต่ละขนาด

แต่ละตัวแปรขนาดจะลบล้างชุดของตัวแปร CSS ผ่านคลาส (เช่น `rdrp-size-small`) นี่คือสิ่งที่แต่ละขนาดปรับเปลี่ยน:
...
สร้างขนาดของคุณเองโดยการกำหนดคลาส CSS ที่จะลบล้างตัวแปรขนาด:
...
หรือด้วย Compound Component API ให้เพิ่มคลาสไปที่ Root:
...
คุณยังสามารถลบล้างตัวแปรขนาดผ่านสไตล์อินไลน์ได้อีกด้วย:
...
<Admonition type="tip">
  ขนาด `medium` เป็นค่าเริ่มต้นและไม่มีการลบล้างใดๆ ตัวแปรพื้นฐานใน `variables.css` คือค่าของขนาด
  medium
</Admonition>
