...
| `highlightDates`         | `Date[]`                                                      | --          | 강조할 날짜들                                               |
| `shouldCloseOnSelect`    | `boolean`                                                     | `false`     | 프리셋 클릭 시 자동 확인                                    |
| `numberOfMonths`         | `number`                                                      | `2`         | 표시할 월의 수                                              |
...
| `name`                   | `string`                                                      | --          | 폼 제출을 위한 숨겨진 input의 name (시작 날짜-시간)         |
| `endName`                | `string`                                                      | --          | 끝 날짜-시간을 위한 숨겨진 input의 name (기본값 `name-end`) |
