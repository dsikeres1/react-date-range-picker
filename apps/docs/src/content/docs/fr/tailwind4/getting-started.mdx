...
Dans ce cas, importez le « rdrp-reset.css » fourni pour initialiser manuellement les styles de boutons :

```tsx
import "react-date-range-picker-tailwind4/rdrp-rdrp-reset.css";
```
