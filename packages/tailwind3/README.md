...
<p align="center">
  <a href="https://dsikeres1.github.io/react-date-range-picker/docs/tailwind3/getting-started"><img src="https://img.shields.io/badge/Documentation-blue?style=flat-square&logo=readthedocs&logoColor=white" alt="Documentation" /></a>
...
> Part of the [React Date Range Picker](https://github.com/dsikeres1/react-date-range-picker) family — Also available: [`tailwind4`](https://www.npmjs.com/package/react-date-range-picker-tailwind4) · [`styled`](https://www.npmjs.com/package/react-date-range-picker-styled) · [`headless`](https://www.npmjs.com/package/react-date-range-picker-headless)
