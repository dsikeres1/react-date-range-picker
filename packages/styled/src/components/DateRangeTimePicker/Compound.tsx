...
export const Root = forwardRef<HTMLDivElement, DateRangeTimePickerRootProps>(
  ({ className, size, ...props }, ref) => (
    <Primitive.Root
      ref={ref}
      className={cn(size && `rdrp-size-${size}`, className)}
      cn={cn}
      size={size}
      {...props}
    />
...
export const Content = forwardRef<HTMLDivElement, ContentProps>(
  ({ className, inlineClassName, ...props }, ref) => (
    <Primitive.Content
      ref={ref}
      className={cn(contentClassNames.content, className)}
...
export const Grid = forwardRef<HTMLDivElement, GridProps>(
  (
    { className, weekdayClassName, weekdaysClassName, weekClassName, gridClassName, ...props },
    ref,
  ) => (
    <Primitive.Grid
      ref={ref}
      ...
      gridClassName={cn(gridClassNames.grid, gridClassName)}
